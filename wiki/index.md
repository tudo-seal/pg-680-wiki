...
![CoSy logo](assets/images/logo.png){ role="img" }

|                   |                                                                                                                                                                                                            |
|-------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Logo              | Kann von der PG ersetzt werden, wenn jemand sowas gerne macht.                                                                                                                                             |
...
-   :material-file-document-outline:{ .lg .middle } __Protokolle__

    ---

    Dokumentation des Projektverlaufs, vergangene Entscheidungen und ihre Begründungen, Tagesordnung für das nächste 
    Meeting. 

    ---

    [:material-arrow-right-box: Anschauen](protocols/template.md)  
...
## Seminarthemen
| **Thema**                                                                 | **Betreuer/in** | **Student/in** | **E-Mail**                      |
|---------------------------------------------------------------------------|-----------------|----------------|---------------------------------|
...
| Pilotprojekte                                                             | Lea             | Fabian         | fabian.lamshoeft@tu-dortmund.de |

## Zitationen
Paper können in Protokollen etc. zitiert werden mit `@cite-key`, solange sie in einer der Bib-Dateien hinterlegt sind (`wiki/bibliographies`), z.B.: 

@robotics-siciliano-2009
